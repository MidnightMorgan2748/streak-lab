  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="border-b border-[var(--border-color)] pb-4">
        <h1 className="text-2xl font-bold tracking-tight text-[var(--text-main)]">Analytics</h1>
      ...
      {/* Placeholder Slate */}
      <div className="flex flex-col items-center justify-center border border-dashed border-[var(--border-color)] p-16 text-center bg-[var(--bg-panel)] min-h-[300px]">
        <div className="w-12 h-12 bg-[var(--bg-app)] border border-[var(--border-color)] flex items-center justify-center text-[var(--text-muted)] mb-4">
        ...
        <h3 className="text-sm font-bold text-[var(--text-main)]">No Analytics Data</h3>
